...
import 'package:malaria_case_report_01/constants/dropdown_options.dart';
...
import 'package:malaria_case_report_01/widgets/form_widgets/simple_form_label.dart';
import 'package:malaria_case_report_01/widgets/form_widgets/simple_radio.dart';
import 'package:malaria_case_report_01/widgets/unit_widgets/checkbox.dart';
...
import 'package:malaria_case_report_01/widgets/unit_widgets/simple_dropdown.dart';
...
class MalariaFormFields {
  ...
  static Future<void> _getVolunteerTownshipVillage(
    ...
    try {
      ...
      formData.volunteerTownshipPlaceholder =
          volunteerInfo['volunteer_township'] ?? 'N/A';
      formData.volunteerVillagePlaceholder =
          volunteerInfo['volunteer_village'] ?? 'N/A';
