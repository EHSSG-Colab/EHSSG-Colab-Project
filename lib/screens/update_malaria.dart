...
import 'package:malaria_case_report_01/screens/malaria/malaria_data_handlers.dart';
import 'package:malaria_case_report_01/screens/malaria/malaria_form_data.dart';
import 'package:malaria_case_report_01/screens/malaria/malaria_form_steps.dart';
import 'package:malaria_case_report_01/screens/malaria/malaria_form_utils.dart';
...
import 'package:malaria_case_report_01/widgets/unit_widgets/notification_dialog.dart';
    ...
    DatabaseHelper().getAllVol().then((value) {
      setState(() {
        formData.volunteerNames = List<String>.from(
          value.map((vol) => vol['volunteer_name'].toString()),
        );
