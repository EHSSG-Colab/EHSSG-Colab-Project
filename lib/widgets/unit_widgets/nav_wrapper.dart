...
class NavWrapper extends StatefulWidget {
  ...
  final List _pages = [Home(), ProfileDetail(), Volunteers(), Info()];
  @override
  Widget build(BuildContext context) {
    ...
    // The nav wrapper is just a scoffold with bottom navigation bar.
      ...
      bottomNavigationBar: BottomNavigationBar(
        currentIndex: _selectedIndex,// currentIndex is the index of the selected item.
        onTap: _onItemTapped,// onTap is the method that will be called when the user press a navigation item.
        /**
